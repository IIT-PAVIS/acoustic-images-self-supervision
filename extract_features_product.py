...
def main(_):
    epoch = FLAGS.epoch
    if FLAGS.mode == 'testing' and (
            epoch == 'random' or epoch == '2' or epoch == '9' or epoch == '19'):
        savemap = True
    else:
        savemap = False
    ...
    with tf.Session(
        ...
        while True:
            try:
                ...
                labels_data, scenario_data, features_audio, features_video, images, product = session.run(
                    [label, scenario, productvectnorm2, productvectnorm,
                     data2, innerdot],
