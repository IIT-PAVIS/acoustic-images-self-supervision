...
def resnet_v1(inputs,
  ...
  with variable_scope.variable_scope(
    ...
    with arg_scope(
        [layers.conv2d, bottleneck_18, resnet_utils.stack_blocks_dense],
      ...
      with arg_scope([layers.batch_norm], is_training=is_training):
        ...
        net = layers.conv2d(
            net, 128, [3, 4], stride=1, padding='valid', scope='conv_map')
...
def resnet_v1_block(scope, base_depth, num_units, stride):
  ...
  """
  return resnet_utils.Block(scope, bottleneck_18, [{
      'depth': base_depth,
      'stride': stride
  }] + [{
      'depth': base_depth,
...
def resnet_v1_18(inputs,
  ...
  blocks = [
      ...
      #resnet_v1_block('block4', base_depth=256, num_units=2, stride=1),
  ]
  return resnet_v1(
      inputs,
      blocks,
